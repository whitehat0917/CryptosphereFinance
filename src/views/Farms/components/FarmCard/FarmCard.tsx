...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'CRY' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      {!removed && (
        <Flex justifyContent='space-between' alignItems='center'>
          <Text style={{ fontSize: '20px' }}>{TranslateString(352, 'APR')}:</Text>
          <Text bold style={{ fontSize: '24px' , display: 'flex', alignItems: 'center' }}>
            {farm.apy ? (
              <>
                <ApyButton
                  lpLabel={lpLabel}
