        ...
        <CardBody>
          <StyledCardContentInner>
            ...
            <RabbitRow>
              <RabbitBox>
                <CardImageFirst>
                  <Image src="/images/lottery/sign bunny 1@2x.png" alt="Number 1" width={200} height={150} responsive />
                </CardImageFirst>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/lottery/sign bunny 2@2x.png" alt="Number 2" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/lottery/sign bunny 3@2x.png" alt="Number 3" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/lottery/sign bunny 4@2x.png" alt="Number 4" width={200} height={150} responsive />
                </CardImage>
              </RabbitBox>
            </RabbitRow>
            <RabbitRowSmall>
